...
[release]: https://github.com/hassio-addons/addon-wireguard/tree/v0.8.1
[wireguard]: https://www.wireguard.com

## Whats different?
This Addon uses exactly the same image as the official [Addon](https://github.com/hassio-addons/addon-wireguard) with `host_network: true`

Why ?
I've deployed a central Wireguard "Hub" to which all my Home Assistant installations connect to. 
this gives me the following advantages:
* have a central point for logging and monitoring
* no NAT/Port forwarding needed on the Home Assistant installations
* central point for all TLS Certificates
